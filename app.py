...
[data-testid="stForm"] [data-testid="stVerticalBlock"]:has(h3):not(:has(button)):hover {
    transform: translateY(-2px);
    box-shadow: 0 15px 35px rgba(0, 0, 0, 0.7), inset 0 2px 6px rgba(255, 255, 255, 0.15) !important;
}
</style>
"""
